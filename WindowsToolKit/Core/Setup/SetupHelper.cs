...
using WindowsToolKit.CoreCompat;

namespace WindowsToolKit.Setup
{
    /// <summary>
    /// Helps setup new WindowsToolKit dependencies, when loaded into target programs
    /// </summary>
    public static class SetupHelper
    {
        ...
        static SetupHelper()
        {
            ...
            // Register the core WindowsToolKit lib
            RegisterAssembly(ReflectionHelper.GetAssembly(typeof(SetupHelper)));
        }

        /// <summary>
        /// Registers the types provided by an assembly to all relevant WindowsToolKit managers
        /// </summary>
